...
gulp.task('copy-resources', function() {
    return merge([
        gulp.src('./revealjs/css/**/*').pipe(gulp.dest('./css/')),
        gulp.src('./revealjs/js/**/*').pipe(gulp.dest('./js/')),
        gulp.src('./revealjs/plugin/**/*').pipe(gulp.dest('./plugin/')),
        gulp.src('./pitc-revealjs-theme/css/theme/source/puzzle-imgs/**/*').pipe(gulp.dest('./css/theme/source/puzzle-imgs/'))
    ])
})
...
gulp.task('default', gulp.series('copy-resources',gulp.parallel('js', 'css', 'plugins'), 'test'))
